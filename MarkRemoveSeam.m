function [mark] = MarkRemoveSeam(specifiedFunctionName)
% Marks the RemoveSeam function
...
% default the function name to RemoveSeam, if no optional arg specified
if nargin == 0
    functionName = 'RemoveSeam';
else
...
expectedOutput = expectedSeamsRemoved;
